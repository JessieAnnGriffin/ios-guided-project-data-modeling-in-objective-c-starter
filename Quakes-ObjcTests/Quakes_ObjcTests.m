...
//    [NSJSONSerialization JSONObjectWithData:quakeData options:NSJSONReadingMutableContainers|NSJSONReadingMutableLeaves error:<#(NSError *__autoreleasing  _Nullable * _Nullable)#>]

    NSError *jsonError = nil;
    NSDictionary *quakeDictionary = [NSJSONSerialization JSONObjectWithData:quakeData options:NSJSONReadingMutableContainers
                                      error:&jsonError]; // NSError **
    if (!quakeDictionary) {
